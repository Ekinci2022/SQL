...
--Parent tabloda olmayan primary key ile child tabloya veri eklenmez


--SORU 3: child tablosuna ted_vergino null olan veri girişi yapınız
insert into child values(null,2001,'Bisiklet','Bayberk');
...
--NOT--
--5.soruda child tablasundaki vergi_no silindigi icin parent tablosoundaki
...
drop table parent2 cascade;
 ...
 --NOT--
--on delete cascade sayesinde child tablo silinmeden parent tablo silinebildi***TABLO*** CHİLD SİLİNMEZ
