...
1) Child tablo silinmeden ,Parent tablo silinemez.

2) Child tablodaki veri silinmeden , Parent tablodaki veri 
silinemez.

3) Child tabloda On delete cascade komutu yazilirsa;

-Child tablo silinmeden parent tablo silinebilir
-Child tablodaki veri silinmeden , parent tablodaki veri silinebilir.
...
--toptancılar  tablosunda irtibat_ismi 'Adem Coş' olan sirket_ismi ile güncelleyiniz.
 ...
 update malzemeler set malzeme_isim=( select sirket_ismi from toptancilar where irtibat_ismi='Mehmet Gör')
