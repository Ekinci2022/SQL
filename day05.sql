...
--HAVING CLAUSE-- HAVING KULLANIMI
...
--Eger bir sehirde calisan personel sayisi 1'den coksa ssehir ismini ve personel sayisini veren sorgu yaziniz
...
/*UNION islemi 2 veya daha cok SELECT isleminin sonuc KUMELERINI birlestirmek icin kullanilir, Ayni kayit birden fazla olursa, 
sadece bir tanesini alir. UNION ALL ise tekrarli elemanlari, tekrar sayisinca yazar.*/
